...
int main()
{
    ...
    cout << "=============================================" << endl;
    cout << "<스탯 관리 시스템>" << endl;
    cout << "1.HP UP" << endl << "2.MP UP" << endl << "3.공격력 UP" << endl << "4.방어력 UP" << endl << "5.현재 능력치" << endl << "6.LEVEL UP" << endl << "0.나가기" << endl;
    ...
    while (1) {
        ...
        if (choice == 0) {
            ...
            cout << "현재 공격력 : " << stat[2] * 2 << endl;
        }
        else if (choice == 4) {
            stat[3] * 2;
            cout << "방어력이 2배로 증가되었습니다. " << endl;
            cout << "현재 방어력 : " << stat[3] * 2 << endl;
        }
        else if (choice == 5) {
        ...
        case 2:
            ...
            if (MPPotion > 0) {
                MPPotion--;
                stat[1] + -20;
                cout << "MP가 20 증가합니다. 포션이 1개 차감됩니다. " << endl;
